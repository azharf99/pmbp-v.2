...
class TilawahForm(forms.ModelForm):
    ...
    class Meta:
        ...
        widgets = {
            ...
            "ayat" : forms.NumberInput(attrs={"class": "rounded-md text-black px-2 py-1 border-2 border-blue-500 dark:border-none shadow-lg"}),
            "surat" : forms.NumberInput(attrs={"class": "rounded-md text-black px-2 py-1 border-2 border-blue-500 dark:border-none shadow-lg"}),
