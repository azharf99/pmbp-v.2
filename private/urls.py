...
urlpatterns = [
    path("", PrivateIndexView.as_view(), name="private-list"),
    ...
    path("subjects/", SubjectIndexView.as_view(), name="subject-list"),
    ...
    path("groups/", GroupIndexView.as_view(), name="group-list"),
